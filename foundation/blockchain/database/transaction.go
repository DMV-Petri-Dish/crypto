...
import (
	...
	"github.com/DMV-Petri-Dish/crypto/foundation/blockchain/signature"
)
...
// SignedTx is a signed version of the transaction. This is how clients like a wallet
// provide transaction for inclusion into the blockchain.
...
// checks the format fo the to account.
...
// This includes a timestamp and gas fees.
type BlockTx struct {
	SignedTx
