...
// blockchain in storage and maintaining an in-memory database of account information
package database
...
func New(genesis genesis.Genesis, storage Storage, evHandler func(v string, args ...interface{})) (*Database, error) {
	db := Database{
		genesis:  genesis,
