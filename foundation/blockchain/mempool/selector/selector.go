...
// account and selects howMany of them in an order based on the functions strategy.
// All selector functions MUST respect nonce ordering.
// Receiving 0 for howMany must return all the transactions in the strategies ordering.
