...
// These fields are safe to be accessed concurrently thanks to expvar
// No extra abstraction required
type metrics struct {
...
// key is how metric values are stored and retrieved
const key ctxKey = 1
...
// AddRequests increments the request metic by 1
